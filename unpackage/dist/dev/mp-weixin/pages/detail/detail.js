...
/***/ 50:
/*!****************************************************************************!*\
  !*** D:/hnuilderx/xmwj/实时热点新闻网/main.js?{"page":"pages%2Fdetail%2Fdetail"} ***!
  \****************************************************************************/
...
/***/ 51:
/*!*********************************************************!*\
  !*** D:/hnuilderx/xmwj/实时热点新闻网/pages/detail/detail.vue ***!
  \*********************************************************/
/*! no static exports found */
...
/***/ 52:
/*!****************************************************************************************!*\
  !*** D:/hnuilderx/xmwj/实时热点新闻网/pages/detail/detail.vue?vue&type=template&id=3e159eb4& ***!
  \****************************************************************************************/
...
/***/ 53:
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--17-0!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/template.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-uni-app-loader/page-meta.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/hnuilderx/xmwj/实时热点新闻网/pages/detail/detail.vue?vue&type=template&id=3e159eb4& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns, recyclableRender, components */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 54:
/*!**********************************************************************************!*\
  !*** D:/hnuilderx/xmwj/实时热点新闻网/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \**********************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 55:
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--13-1!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/script.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/hnuilderx/xmwj/实时热点新闻网/pages/detail/detail.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
  ...
  methods: {
    getDetail: function getDetail() {
      ...
      uni.request({
        ...
        // 因为this.options的值就是一个含有键值对classname、id的对象，data的值要求是一个对象，所以可以这么写,意思为带着数据this.options向后端发送请求
        data: this.options,
        success: function success(res) {
          console.log(res.data);
          res.data.posttime = (0, _dayjs.default)(res.data.posttime).format('YYYY-MM-DD HH:mm:ss');
          // 这活本应给前端做，就用不着这么麻烦把接收到的数据res.data.content中存着的带有标签的字符串里面的所有<img字符串替换成<img style="max-width:100%"了，字符串res.data.content调用replace方法，会检索res.data.content中所有含有第一个形参的字符串，然后全部替换成第二个形参。
          // gi是正则表达式
    ...
    // 倒数第二个需求：用户点击新闻后，浏览过的新闻放到个人中心的历史记录里面。
    // uni.setStorageSync(a,b)方法执行后会（同步方法）在本地存储中存放属性名为该方法的第一个形参、属性值为该方法第二个形参的键值对。uni.getStorageSync(a,b)方法执行后会从本地缓存（右键网页-检查-application-local storage）中获取属性名为该方法第一个形参的键值对的属性值
    saveHistory: function saveHistory() {
      var _this2 = this;
      // 获取本地存储中属性名叫historyarr的属性值，如果没有就创建个空数组，再赋值给变量historyarr
      var historyArr = uni.getStorageSync("historyArr") || [];
      // 往数组historyArr中放当前新闻详情页展示的新闻的calsstime等数据。相当于把新闻列表组件newbox组件中要展示的所有数据（图片、标题、时间）和该组件绑定的响应函数goDetail中发送请求时需要携带的参数calssname、id都存到item变量中去
      var item = {
        id: this.detail.id,
        classid: this.detail.classid,
        picurl: this.detail.picurl,
        title: this.detail.title,
        looktime: (0, _dayjs.default)(Date.now())
      };
      // 最后一个需求：去掉浏览历史中重复的新闻记录。解决思路：只有点进新闻详情页才会在本地存储中保存当前新闻的数据信息，那么在保存前，让当前新闻详情页展示的新闻的id数据跟此时本地存储中historyArr的属性值中的所有元素中的id做对比，如果有相同，则删除该id的元素，再往后执行在数组historyArr的最开始位置存储当前新闻详情页展示的新闻信息即可。这样一来不仅不会出现重复的浏览记录，而且已经浏览过的新闻如果用户再次浏览，那么旧的浏览记录会被删除，并且该条浏览记录会重新出现在历史记录的第一条。另一种思路是修改本地存储中重复新闻记录元素中的时间，比较用户重新浏览了浏览过的新闻，那么这两条记录里面只有浏览时间looktime不一样。在本地存储中通过looktime来保留新的那条浏览记录即historyArr中的元素
      // findIndex（箭头函数）方法中的箭头函数中的return返回的表达式的值为true时，该方法findindex的返回值就是此时遍历到的元素的索引值（即返回该元素是数组中索引值为？的元素），反之，findindex函数就会返回-1，代表数组中没有满足箭头函数中表达式的元素。
      // 在向historyArr变量中存新的item前，先让histArr经过findindex方法遍历一遍，如果出现数组histArr中的某个元素中的id的值跟上面63行的item（即此时详情页展示的新闻的信息对象）中的id的值是否一样，如果一样（findindex方法会返回一样的那个元素的索引值），删掉historyArr中的该元素
      var index = historyArr.findIndex(function (i) {
        return i.id == _this2.detail.id;
      });
      if (index >= 0) {
        // index>=0代表有重复新闻，index的值就是historyarr数组中重复新闻的元素的索引值，数组。splice（a,b）方法，从数组第a个索引值位置开始删，往后删b个元素
        historyArr.splice(index, 1);
      }
      // 将当前item对象放到此时的数组historyArr里面。这样一来每当用户浏览一篇新闻后，本地缓存中属性historyarr的属性值即数组里面就会多一个元素item，每个元素都分别保存这=着用户浏览过的新闻数据.unshift()在数组最开始位置存放元素
      historyArr.unshift(item);

      // 如果嫌本地存储中的浏览历史太多，不想一次性都展示出来，可以用slice截取前十条，再存进去
...
/***/ 57:
/*!*******************************************************************************************!*\
  !*** D:/hnuilderx/xmwj/实时热点新闻网/pages/detail/detail.vue?vue&type=style&index=0&lang=scss& ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ 58:
/*!***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/mini-css-extract-plugin/dist/loader.js??ref--8-oneOf-1-0!./node_modules/css-loader/dist/cjs.js??ref--8-oneOf-1-1!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-2!./node_modules/postcss-loader/src??ref--8-oneOf-1-3!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/sass-loader/dist/cjs.js??ref--8-oneOf-1-4!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/webpack-preprocess-loader??ref--8-oneOf-1-5!./node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib??vue-loader-options!./node_modules/@dcloudio/webpack-uni-mp-loader/lib/style.js!D:/hnuilderx/xmwj/实时热点新闻网/pages/detail/detail.vue?vue&type=style&index=0&lang=scss& ***!
  \***********************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
